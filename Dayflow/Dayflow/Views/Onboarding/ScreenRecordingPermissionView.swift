    ...
    ZStack(alignment: .bottomTrailing) {
      HStack(alignment: .top, spacing: 60) {
        ...
        VStack(alignment: .leading, spacing: 10) {
          ...
          Text("Sled can help understand your day.")
          ...
          VStack(alignment: .leading, spacing: 10) {
            HStack(alignment: .top, spacing: 8) {
              ...
              Text("Sled is built to be private and secure.")
            ...
            Text(
              "Sled stores all recordings locally on your Mac, and can process everything privately on your device using local AI models."
            )
            .font(.custom("Figtree-Medium", size: 14))
            .foregroundColor(privacyTextColor)

            Text("You are always in control — you can pause or turn off Sled whenever you like.")
              .font(.custom("Figtree-Medium", size: 14))
              .foregroundColor(privacyTextColor)
          }
          .padding(16)
          ...
          Group {
            ...
            case .needsAction:
              Text("Turn on Screen Recording for Sled, then quit and reopen the app to finish.")
                .font(.custom("Figtree", size: 14))
