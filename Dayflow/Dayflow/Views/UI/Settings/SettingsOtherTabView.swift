    ...
    SettingsSection(
      ...
      VStack(alignment: .leading, spacing: 0) {
        ...
        SettingsRow(
          ...
          subtitle: "When off, Sled runs as a menu bar-only app."
        ) {
        ...
        SettingsRow(
          ...
          subtitle:
            "When off, Sled won't automatically open goal setup or yesterday's review after 4am."
        ) {
