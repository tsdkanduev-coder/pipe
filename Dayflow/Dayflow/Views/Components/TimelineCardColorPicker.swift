...
struct ColorOrganizerRoot: View {
    ...
    VStack(alignment: .leading, spacing: showTitles ? 20 : 16) {
      ...
      VStack(alignment: .leading, spacing: 16) {
        instructionRow(
          ...
          text:
            "Sled organizes your activities by the category titles and descriptions you provide."
        )
      ...
      Text(
        "This step is optional. You can customize the categories or create new ones anytime while using Sled."
      )
  ...
  private func colorAssignmentPanel(isCompact: Bool) -> some View {
    ...
    return VStack(alignment: .leading, spacing: 16) {
      ...
      Text("This step is optional. You can change the colors anytime while using Sled.")
        .font(Font.custom("Figtree", size: 12).weight(.medium))
        .foregroundColor(Color(red: 0.48, green: 0.48, blue: 0.48))
        .frame(maxWidth: .infinity, alignment: .leading)
